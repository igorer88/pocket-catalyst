...
export class InitialSchema1759889806706 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "UserSecurity" ("id" varchar PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "deleted_at" datetime, "interface_lock_pin_hash" varchar, "pin_attempts" integer NOT NULL DEFAULT (0), "pin_locked_until" datetime, "recovery_hint" varchar(100), "recovery_email" varchar(50), "phone" varchar(15), "biometric_enabled" boolean NOT NULL DEFAULT (0), "biometric_last_used" datetime, "user_id" varchar, CONSTRAINT "UQ_a9a3844e6c3310aa2cb40ead4b8" UNIQUE ("recovery_email"), CONSTRAINT "UQ_USER_SECURITY_RECOVERY_EMAIL" UNIQUE ("recovery_email"), CONSTRAINT "UQ_USER_SECURITY_USER_ID" UNIQUE ("user_id"), CONSTRAINT "REL_b960c461bb21bf2820b42ac2d6" UNIQUE ("user_id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_Profiles"("id", "created_at", "updated_at", "deleted_at", "first_name", "last_name", "locale", "display_currency", "extra_settings", "user_id") SELECT "id", "created_at", "updated_at", "deleted_at", "first_name", "last_name", "locale", "display_currency", "extra_settings", "user_id" FROM "Profiles"`
    )
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_UserSecurity"("id", "created_at", "updated_at", "deleted_at", "interface_lock_pin_hash", "pin_attempts", "pin_locked_until", "recovery_hint", "recovery_email", "phone", "biometric_enabled", "biometric_last_used", "user_id") SELECT "id", "created_at", "updated_at", "deleted_at", "interface_lock_pin_hash", "pin_attempts", "pin_locked_until", "recovery_hint", "recovery_email", "phone", "biometric_enabled", "biometric_last_used", "user_id" FROM "UserSecurity"`
    )
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "UserSecurity"("id", "created_at", "updated_at", "deleted_at", "interface_lock_pin_hash", "pin_attempts", "pin_locked_until", "recovery_hint", "recovery_email", "phone", "biometric_enabled", "biometric_last_used", "user_id") SELECT "id", "created_at", "updated_at", "deleted_at", "interface_lock_pin_hash", "pin_attempts", "pin_locked_until", "recovery_hint", "recovery_email", "phone", "biometric_enabled", "biometric_last_used", "user_id" FROM "temporary_UserSecurity"`
    )
    ...
    await queryRunner.query(
      `INSERT INTO "Profiles"("id", "created_at", "updated_at", "deleted_at", "first_name", "last_name", "locale", "display_currency", "extra_settings", "user_id") SELECT "id", "created_at", "updated_at", "deleted_at", "first_name", "last_name", "locale", "display_currency", "extra_settings", "user_id" FROM "temporary_Profiles"`
    )
