...
export class InitialSchema1759889806706 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_UserSecurity"("id", "created_at", "updated_at", "deleted_at", "user_id", "interface_lock_pin_hash", "pin_attempts", "pin_locked_until", "recovery_hint", "recovery_email", "phone", "biometric_enabled", "biometric_last_used") SELECT "id", "created_at", "updated_at", "deleted_at", "user_id", "interface_lock_pin_hash", "pin_attempts", "pin_locked_until", "recovery_hint", "recovery_email", "phone", "biometric_enabled", "biometric_last_used" FROM "UserSecurity"`
    )
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "UserSecurity"("id", "created_at", "updated_at", "deleted_at", "interface_lock_pin_hash", "pin_attempts", "pin_locked_until", "recovery_hint", "recovery_email", "phone", "biometric_enabled", "biometric_last_used", "user_id") SELECT "id", "created_at", "updated_at", "deleted_at",  "user_id", "interface_lock_pin_hash", "pin_attempts", "pin_locked_until", "recovery_hint", "recovery_email", "phone", "biometric_enabled", "biometric_last_used" FROM "temporary_UserSecurity"`
    )
